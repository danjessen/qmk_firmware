...
[_SP] = LAYOUT_all(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   US_OSTR, _______, _______,  _______, _______, _______,
  _______, US_ARNG, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,  _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, US_AE,    _______, _______,
  _______, _______, _______,                   _______,                            _______, _______, _______,  _______, _______, _______),
};
