...
[_MA] = LAYOUT_all(
  ...
  KC_TILD, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  _______, KC_ENT,
...
[_FL] = LAYOUT_all(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, US_OSTR, _______, _______,  _______, _______, KC_INS,
  _______, US_ARNG, _______, _______, _______, TG(_GA), _______, _______, _______, _______, _______, _______,  _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, US_AE,    _______, _______,
